...
// Chỉ giữ nạp tiền bằng chuyển khoản / Autobank.
// Nạp thẻ cào tự động đã tắt hoàn toàn.
...
// Thông tin chuyển khoản hiện tại của web.
    ...
    <div class="box_list_chuyenmuc">
        <div class="box_midss">
            <div class="box_detai" style="padding:5px;">
                <center>
                    <b style="color:green">CHUYỂN KHOẢN / AUTOBANK</b>
                    <br>
                ...
                ">
                    ...
                    <div style="flex:1; padding:10px; font-family:'Times New Roman',serif;">
                        <p style="margin:5px 0;">
                            <b>Tên Tài Khoản:</b>
                            <?= htmlspecialchars($chutaikhoan) ?>
                        </p>

                        <p style="margin:5px 0;">
                            <b>Số Tài Khoản:</b>
                            <?= htmlspecialchars($stk) ?>
                        </p>

                        <p style="margin:5px 0;">
                            <b>Ngân Hàng:</b>
                            <?= htmlspecialchars($tennh) ?>
                        </p>
                        ...
                        <p style="margin:5px 0;">
                            ...
                            <button
                                type="button"
                                onclick="navigator.clipboard.writeText(document.getElementById('nd').innerText)"
                            >Copy</button>
                        </p>

                        <p style="margin:10px 0;">
                            <b>Nạp ATM được cộng thêm 10%</b>
                        </p>

                        <p style="margin:10px 0;">
                            <b>Nạp ATM tối thiểu 10.000đ mới cộng nhé</b>
                        </p>

                        <p style="margin:10px 0;">
                            <b>Lỗi nạp báo ngay Admin: Zalo: 0982542412</b>
                        </p>
                    </div>
                </div>
